...
var NewsPage = /** @class */ (function (_super) {
    ...
    function NewsPage() {
        ...
        //search
        _this.divsearchinput = _this.ElementLocator(Locators.searchinput);
        return _this;
    }
    NewsPage.prototype.Search = function (search) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log("search this :" + search);
                this.divsearchinput.all(protractor_1.by.tagName("input")).then(function (elems) {
